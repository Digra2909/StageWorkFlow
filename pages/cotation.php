                    ...
                    <form action="root.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="connaissance_professionelles" placeholder="1. Connaissances Professionnelles (0-20)"  required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="rendement" placeholder="2. Rendement (0-20)"  required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="esprit_initiative" placeholder="3. Esprit d'Initiative (0-20)"  required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="ponctualite_ordre_discioline" placeholder="4. Ponctualité, Ordre et Discipline (0-20)"  required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="collaboration_travail_equipe" placeholder="5. Collaboration et Travail d'Équipe (0-20)"  required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="conscience_prof" placeholder="6. Conscience Professionnelle (0-20)"  required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="comportement_generale" placeholder="7. Comportement Général (0-20)"  required>
                            </div>
                        </div>
